...
// Grainient — animated grainy WebGL gradient (React Bits, https://reactbits.dev; MIT), on ogl.
// Vendored from the product app (ui repo) so both stay in sync shader-for-shader.
